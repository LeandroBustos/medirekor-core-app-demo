    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <input type="text" style={{"paddingLeft":"30px","width":"100%","border":"1px solid black","borderRadius":"5px"}} placeholder="User"/>
                ...
                >
                    <input type="password" style={{"paddingLeft":"30px","width":"100%","border":"1px solid black","borderRadius":"5px"}} placeholder="Password"/>
